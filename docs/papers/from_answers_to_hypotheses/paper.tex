...
A dedicated reproduction notebook,
\texttt{notebooks/from_answers_to_hypotheses/20\_paper\_reproduce.ipynb},
reproduces all reported figures and statistical analyses using the released
model outputs, without requiring rerunning model generation.
For full end-to-end reproduction, including stochastic model generation,
the generation notebook \texttt{notebooks/from_answers_to_hypotheses/10\_colab\_generate.ipynb}
can be executed prior to the reproduction notebook.
