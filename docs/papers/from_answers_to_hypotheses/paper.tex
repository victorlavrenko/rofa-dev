...
\begin{itemize}
  ...
  {\small[\href{https://colab.research.google.com/github/victorlavrenko/rofa/blob/paper/from-answers-to-hypotheses-v1/notebooks/20_paper_reproduce.ipynb}{Colab}]}
  ...
  {\small[\href{https://colab.research.google.com/github/victorlavrenko/rofa/blob/paper/from-answers-to-hypotheses-v1/notebooks/10_colab_generate.ipynb}{Colab}]}
\end{itemize}
